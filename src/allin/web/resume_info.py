...
from allin.web.resume_original import resolve_configured_resume_files
from allin.web.resume_text import resume_cache_buster, sanitize_resume_text
...
def ensure_resume_markdown_file(configured_path: Path) -> Path | None:
	...
	from allin.web.resume_upload import pdf_to_markdown
