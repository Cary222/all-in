...
export function RecycleBinPanel({
  ...
  return (
    <div className="rounded-3xl border border-card-border bg-surface-raised p-5">
      <div className="mb-4 flex flex-wrap items-start justify-between gap-4">
        ...
        <span className="rounded-full bg-primary/10 px-3 py-2 text-xs font-black text-primary">{jobs.length} 条</span>
      </div>
      {loading ? <div className="rounded-2xl border border-card-border bg-slate-50 p-6 text-center text-sm text-muted">正在读取回收站...</div> : (
        <>
          <div className="mb-4 flex flex-wrap items-center gap-2 text-xs">
            ...
            <span className="rounded-full bg-primary/10 px-3 py-2 font-bold text-primary">已选择 {selectedIds.length} 条</span>
