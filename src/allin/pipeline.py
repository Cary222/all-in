"""Pipeline - orchestrates the full All In flow."""

from rich.console import Console

from allin.browser import check_chrome_connection, configure, find_boss_tab
...
def run_pipeline(config: dict) -> None:
    ...
    if not version_info:
        console.print("[red]✗ Browser Runtime 未连接，请先运行 allin connect 查看诊断[/red]")
        return
