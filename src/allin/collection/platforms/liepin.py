...
from allin.browser import close_tab, evaluate, navigate as browser_navigate, new_tab, scroll, wait_for_load
...
class LiepinCollector:
    ...
    def _resume_ttl_hours(self) -> int:
        ...
        return resolve_resume_ttl_hours(self.config, "liepin")
