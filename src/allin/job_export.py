...
from allin.cities import get_city_code
...
def export_jobs(
	...
	*,
	...
	if format == "csv":
		return build_csv(rows), "text/csv; charset=utf-8", "allin-jobs.csv"
	if format == "xlsx":
		return build_xlsx(rows), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "allin-jobs.xlsx"
