...
from allin.ai.scorer import ScoreOutcome, score_jobs
...
def test_pause_checkpoint_keeps_current_and_unstarted_jobs_for_recovery(tmp_path):
	...
	with (
		...
		patch("allin.ai.scorer._load_resume", return_value="real resume"),
		patch("allin.ai.scorer.quick_score", return_value=(80, "pass")),
