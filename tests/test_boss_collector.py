...
from allin.collection.platforms.boss import (
    ...
    def test_failed_save_or_failed_page_never_advances_past_the_gap(self):
        for failure in ("save", "page"):
            with self.subTest(failure=failure), tempfile.TemporaryDirectory() as tmp:
                ...
                if failure == "save":
                    from allin.collection.orchestrator import insert_job_if_new
                    attempts = []
                    ...
                    with patch("allin.collection.orchestrator.insert_job_if_new",
...
class BossEdgeCaseTests(TestCase):
    ...
    def test_normalize_filters_non_dict_returns_empty(self):
        from allin.collection.platforms.boss import normalize_boss_search_filters
    ...
    def test_wait_or_stop_with_stop_event_set(self):
        ...
        from allin.collection.platforms.boss import _wait_or_stop
        stop = Event()
        stop.set()
    ...
    def test_positive_int_invalid_returns_default(self):
        from allin.collection.platforms.boss import _positive_int
    ...
    def test_bounded_float_invalid_returns_default(self):
        from allin.collection.platforms.boss import _bounded_float
