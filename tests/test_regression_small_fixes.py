...
class VersionMetadataTests(unittest.TestCase):
    def test_release_version_is_consistent(self):
        ...
        import allin
        from allin.web.server import health
        ...
        version = "2.4.0"
        frontend = ROOT / "src" / "allin" / "web" / "frontend"
        ...
        self.assertEqual(allin.__version__, version)
...
class AiPromptRegressionTests(unittest.TestCase):
    def test_scorer_prompt_uses_universal_weighted_evidence(self):
        from allin.ai.scorer import SCORING_PROMPT
...
class ConfirmationUiTests(unittest.TestCase):
    @patch("allin.ui.confirm.Prompt.ask")
    @patch("allin.ui.confirm.get_jobs_pending_confirmation")
    @patch("allin.ui.confirm.get_db")
