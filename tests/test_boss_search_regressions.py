...
from allin.collection_run_store import get_collection_run, boss_combo_key
from allin.db import get_db, count_platform_access_today
...
class BossSearchRegressionTests(TestCase):
    ...
    def test_salary_decode_failure_action_defaults_to_stop(self):
        from allin.collection.platforms.boss import _salary_decode_failure_action
