...
from allin.web.preflight import collect_preflight_checks
from allin.web.server import _preflight_messages
...
class CollectionPreflightTests(TestCase):
    def test_pure_collection_does_not_call_ai_even_when_ai_configured(self):
        ...
        with patch("allin.web.preflight.check_ai_connection") as check_ai, patch(
            "allin.web.preflight.check_browser_connection",
